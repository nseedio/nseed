...
{
    public class UsageOfRequiresSeedBucketFixture01 : IClassFixture<RequiresSeedBucket<DotNetCoreSeedsSeedBucket>>
    {
        private readonly ITestOutputHelper output;

        public UsageOfRequiresSeedBucketFixture01(ITestOutputHelper output)
        {
            this.output = output;
        }
