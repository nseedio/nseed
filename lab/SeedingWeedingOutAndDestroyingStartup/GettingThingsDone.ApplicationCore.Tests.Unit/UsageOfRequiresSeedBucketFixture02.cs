...
{
    public class UsageOfRequiresSeedBucketFixture02 : IClassFixture<RequiresSeedBucket<DotNetCoreSeedsSeedBucket, SampleStartupForUnitTests>>
    {
        private readonly ITestOutputHelper output;

        public UsageOfRequiresSeedBucketFixture02(ITestOutputHelper output)
        {
            this.output = output;
        }
